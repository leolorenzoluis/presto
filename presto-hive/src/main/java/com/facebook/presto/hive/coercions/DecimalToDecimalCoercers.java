...
public class DecimalToDecimalCoercers
{
    private DecimalToDecimalCoercers()
    {
    }

    public static Function<Block, Block> createCoercer(DecimalType fromType, DecimalType toType)
    {
